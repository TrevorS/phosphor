...
**109 of 119 tasks are assigned**, each to exactly one owner. `T005` is the single deliberate
...
tasks   2   5   8   6   15   24   22   17   14   3   1
```
...
| | |
|---|---|
| `T001` gates **109 of 119** tasks | The workspace skeleton is the whole build's front door. |
| `T019` gates **79** | The `Action` enum. The plan calls it "reversible: no in practice." |
...
> green: 220 capabilities, three doors derived from one table, 660 door checks walked end to
