...
(declare-regions! (list (hash "path" "src/retry.rs" "span" (hash "start" (hash "line" 4 "column" 1) "end" (hash "line" 4 "column" 18)) "author" "claude") (hash "path" "src/retry.rs" "span" (hash "start" (hash "line" 6 "column" 1) "end" (hash "line" 10 "column" 2)) "author" "claude") (hash "path" "src/retry.rs" "span" (hash "start" (hash "line" 12 "column" 1) "end" (hash "line" 24 "column" 51)) "author" "claude") (hash "path" "src/fetch.rs" "span" (hash "start" (hash "line" 10 "column" 1) "end" (hash "line" 14 "column" 2)) "author" "claude") (hash "path" "src/fetch.rs" "span" (hash "start" (hash "line" 17 "column" 1) "end" (hash "line" 20 "column" 2)) "author" "claude") (hash "path" "src/fetch.rs" "span" (hash "start" (hash "line" 31 "column" 1) "end" (hash "line" 35 "column" 2)) "author" "claude") (hash "path" "src/deploy" "span" (hash "start" (hash "line" 18 "column" 1) "end" (hash "line" 20 "column" 2)) "author" "claude")))
